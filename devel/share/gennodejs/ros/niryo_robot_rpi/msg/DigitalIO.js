...
class DigitalIO {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DigitalIO
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DigitalIO
    let len;
    let data = new DigitalIO(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DigitalIO(null);
