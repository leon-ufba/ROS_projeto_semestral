...
class HardwareStatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.hardware_errors_message = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('hardware_state')) {
        this.hardware_state = initObj.hardware_state
      }
      else {
      ...
      if (initObj.hasOwnProperty('hardware_errors_message')) {
        this.hardware_errors_message = initObj.hardware_errors_message
      }
      else {
        this.hardware_errors_message = [];
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [hardware_state]
    bufferOffset = _serializer.int8(obj.hardware_state, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.bool(obj.calibration_needed, buffer, bufferOffset);
    ...
    // Serialize message field [hardware_errors_message]
    bufferOffset = _arraySerializer.string(obj.hardware_errors_message, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [hardware_state]
    data.hardware_state = _deserializer.int8(buffer, bufferOffset);
    ...
    data.calibration_needed = _deserializer.bool(buffer, bufferOffset);
    ...
    // Deserialize message field [hardware_errors_message]
    data.hardware_errors_message = _arrayDeserializer.string(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.hardware_errors_message.forEach((val) => {
      length += 4 + val.length;
    });
    return length + 40;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.hardware_state !== undefined) {
      resolved.hardware_state = msg.hardware_state;
    }
    else {
      resolved.hardware_state = 0
    }
    ...
    if (msg.calibration_needed !== undefined) {
      ...
      resolved.calibration_needed = false
    }
    ...
    if (msg.hardware_errors_message !== undefined) {
      resolved.hardware_errors_message = msg.hardware_errors_message;
    }
    else {
      resolved.hardware_errors_message = []
    }
