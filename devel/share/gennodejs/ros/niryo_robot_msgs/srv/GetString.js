...
class GetStringRequest {
  ...
  static datatype() {
    ...
    return 'niryo_robot_msgs/GetStringRequest';
  }
...
class GetStringResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'niryo_robot_msgs/GetStringResponse';
  }
...
module.exports = {
  ...
  md5sum() { return '64e58419496c7248b4ef25731f88b8c3'; },
  datatype() { return 'niryo_robot_msgs/GetString'; }
};
