...
echo_and_run cd "/home/leon/catkin_ws_niryo_ned/src/niryo_robot_poses_handlers"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/leon/catkin_ws_niryo_ned/src/niryo_robot_poses_handlers/setup.py" \
    egg_info --egg-base /home/leon/catkin_ws_niryo_ned/build/niryo_robot_poses_handlers \
    build --build-base "/home/leon/catkin_ws_niryo_ned/build/niryo_robot_poses_handlers" \
    install \
    --root="${DESTDIR-/}" \
