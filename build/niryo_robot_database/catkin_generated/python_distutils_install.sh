...
echo_and_run cd "/home/leon/catkin_ws_niryo_ned/src/niryo_robot_database"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/leon/catkin_ws_niryo_ned/src/niryo_robot_database/setup.py" \
    egg_info --egg-base /home/leon/catkin_ws_niryo_ned/build/niryo_robot_database \
    build --build-base "/home/leon/catkin_ws_niryo_ned/build/niryo_robot_database" \
    install \
    --root="${DESTDIR-/}" \
